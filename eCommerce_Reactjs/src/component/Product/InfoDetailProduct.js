                            ...
                            <ol className="carousel-indicators">
                                {arrDetail && arrDetail.productImage && arrDetail.productImage.length > 0 &&
                                    arrDetail.productImage.map((item, index) => {
                                        if (index === 0) {
                                            return (
                                                <li data-target="#carouselExampleIndicators" data-slide-to={index} key = {index} className="active">
                                                    <img height="60px" className="w-100" src={item.image} alt="" />
                                                </li>
                                            )
                                        } else {
                                            return (
                                                <li data-target="#carouselExampleIndicators" data-slide-to={index} key = {index} className="">
                                                    <img height="60px" className="w-100" src={item.image} alt="" />
                                                </li>
                                            )
                                        }
                                ...
                                arrDetail.productImage.map((item, index) => {
                                    if (index === 0) {
                                        return (
                                            ...
                                            <div onClick={() => openPreviewImage(item.image)} key = {index} style={{ cursor: 'pointer' }} className="carousel-item active">
                                        ...
                                        return (
                                            ...
                                            <div onClick={() => openPreviewImage(item.image)}key = {index} style={{ cursor: 'pointer' }} className="carousel-item ">
                                                <img className="d-block w-100"
                                                    src={item.image} alt="Ảnh bị lỗi" />
                                            </div>
                                        )
